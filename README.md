...
#### Landing Page:
After application is up go to [http://localhost:1337](http://localhost:1337) you will be directed to [http://localhost:1337/#/landing](http://localhost:1337/#/landing) which is the landing page defined in sailsAngularApp\views\landing.ejs
